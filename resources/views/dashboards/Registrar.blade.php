    ...
    <div class="ent-card-body">
        <div class="dash-action-grid">
            <a href="{{ route('students.index') }}"    class="dash-action-card">
                <div class="dash-action-icon"><i class='bx bx-group'></i></div>
            ...
            <a href="{{ route('students.create') }}"   class="dash-action-card">
                <div class="dash-action-icon"><i class='bx bx-user-plus'></i></div>
            ...
            <a href="{{ route('management.users.index') }}" class="dash-action-card">
                <div class="dash-action-icon"><i class='bx bx-user-pin'></i></div>
